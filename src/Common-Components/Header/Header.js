...
class header extends Component {
  ...
  toggle() {
    this.setState((prevState) => ({
      ...
      portfoliohover: !prevState.portfoliohover
    }));
  }

  onMouseEnter() {
    this.setState({ dropdownhover: true });
    this.setState({portfoliohover: true});
  }

  onMouseLeave() {
    this.setState({ dropdownhover: false });
    this.setState({portfoliohover: false});
  }
          ...
          <MainHeaderContainer>
            ...
            <Navigation>
              <NavMenu className="Menu">
                ...
                >
                  <Navmenulist className="current">Home</Navmenulist>
                ...
                <li className="dropdown">
                  <Navmenulist href="#" className="current">
                    <div onClick={() => history.push("Contactus")}>CONTACT</div>
                  </Navmenulist>
                </li>
                {/* ***********SEARCH ICON ******************** */}
